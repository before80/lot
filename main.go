...
func main() {
	...
	//drawNum2Type2NotExistCount := ana_dlt.MinComb(allDlts, 0, "07001")
	//fmt.Printf("drawNum2Type2NotExistCount=%v\n", drawNum2Type2NotExistCount)

	////var counts []*ana_dlt.NumCount
	//var counts1 []*ana_dlt.EqNumCount
	//var counts2 []*ana_dlt.EqAnyCount
	//counts = ana_dlt.FMaxOne(allDlts)
	//for _, c := range counts {
	//	fmt.Printf("count: %v\n\n\n", c)
	//}

	//counts = ana_dlt.BMaxOne(allDlts)
	//for _, c := range counts {
	//	fmt.Printf("count: %v\n\n\n", c)
	//}

	//counts = ana_dlt.BMaxTwo(allDlts)
	//for _, c := range counts {
	//	fmt.Printf("count: %v\n\n\n", c)
	//}

	//counts = ana_dlt.FMaxTwo(allDlts)
	...
	//counts = ana_dlt.FMaxThree(allDlts)
	//for k, c := range counts {
	//	if k > 10 {
	//		break
	//	}
	...
	//counts = ana_dlt.FMaxFour(allDlts)
	//for k, c := range counts {
	//	if k > 20 {
	//		break
	//	}
	...
	//	counts1, drawNums = ana_dlt.EqNFBIntervalDrawNumSpNum(allDlts, 1, 50, 1, legend, true)
	//	var y []string
	...
	//
	//for _, legend := range legends1 {
	//	counts1, drawNums = ana_dlt.EqNFBIntervalDrawNumSpNum(allDlts, 2, 50, 1, legend, true)
	//	var y []string
	//	for _, c := range counts1 {
	//		y = append(y, strconv.Itoa(c.Count))
	//	}
	...
	//
	//for _, legend := range legends1 {
	//	counts1, drawNums = ana_dlt.EqNFBIntervalDrawNumSpNum(allDlts, 3, 50, 1, legend, true)
	//	var y []string
	//	for _, c := range counts1 {
	//		y = append(y, strconv.Itoa(c.Count))
	//	}
	...
	//
	//for _, legend := range legends1 {
	//	counts2, drawNums = ana_dlt.EqAnyFBIntervalDrawNumSpNum(allDlts, 50, 1, legend, true)
	//	var y []string
	...
	//
	////fmt.Printf("comb: %v\n\n\n", ana_dlt.GenComb([]string{"01", "02", "03", "04", "05"}, 3))
	//
	...
	//fmt.Printf("combCount: %d\n\n\n", ana_dlt.CalCombCount())
	//counts, existCombs, drawNum2CombNums := ana_dlt.MaxComb(allDlts)
	//_ = drawNum2CombNums
	//_ = counts
	//_ = existCombs
